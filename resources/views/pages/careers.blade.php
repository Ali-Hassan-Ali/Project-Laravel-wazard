...
<script>
    function myFunction() {
        ...
        cards = cardContainer.getElementsByClassName("display_none");
...
<script>
    function Filterjobs() {
        var input, filter, boxs, cardContainer, h5, title, i;
        input = document.getElementById("myFilter_jobs");
        filter = input.value.toUpperCase();
        cardContainer = document.getElementById("myJobs");
        boxs = cardContainer.getElementsByClassName("display_none");
        for (i = 0; i < boxs.length; i++) {
            title = boxs[i].querySelector(".item-details .new-time .job-title .job_name span");
            if (title.innerText.toUpperCase().indexOf(filter) > -1) {
