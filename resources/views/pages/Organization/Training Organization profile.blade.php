                    ...
                    <section class="widget" style="background-color: #fafafb;">
                        <header>
                            <div class="row">
                                <div class="col-lg-12">
                            <h5>
                                Training  <span class="fw-semi-bold">Org Profile</span>
                            </h5>
                                </div>
                            </div>
                        </header>
                                    ...
                                    <div class="data-box">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <p><span><i class="fa fa-id-badge"></i></span><span class="font-weight-bolder"> Rate: </span><span class="badge badge-warning" id="badge">4</span></p>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                    <div class="data-box">
                                        ...
                                        <div class="output-data">
                                            ...
                                            <div class="row">
                                                <p class="fw-semi-bold col-lg-10">advertisement</p>
                                            </div>
                                    </div>
                                </div>
                            </div>
