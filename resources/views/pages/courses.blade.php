                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 mb-5">
                                <a href="{{ route('web_development.index')}}" class="link-course">
                                    <div class="card card-block">
                                        <img class="track_img"
                                             src="https://img-a.udemycdn.com/course/240x135/851712_fc61_5.jpg"
                                             alt="Photo of sunset">
                                        <h5 class="card-title mt-3 mb-3"> Web Development</h5>
                                        <p class="card-text">Learn the Basics. Every Web Developer must have a basic
                                            understanding of HTML, CSS, and JavaScript</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 mb-5">
                                <a href="{{ route('mobile_app.index')}}" class="link-course">
                                    <div class="card card-block">
                                        <img class="track_img"
                                             src="https://img-a.udemycdn.com/course/240x135/1708340_7108_4.jpg"
                                             alt="Photo of sunset">
                                        <h5 class="card-title  mt-3 mb-3">Mobile Application</h5>
                                        <p class="card-text">A mobile application, also referred to as a mobile app or
                                            simply an app, is a computer program or software application designed to run
                                            on a mobile .</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 mb-5">
                                <a href="{{ route('cyber_security.index')}}" class="link-course">
                                    <div class="card card-block">
                                        <img class="track_img"
                                             src="https://img-a.udemycdn.com/course/240x135/614772_233b_9.jpg"
                                             alt="Photo of sunset">
                                        <h5 class="card-title  mt-3 mb-3">cyber security</h5>
                                        <p class="card-text">Cyber security is the practice of defending computers,
                                            servers, mobile devices, electronic systems, networks, and data from
                                            malicious attacks. It's also known as information technology security.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 mb-5">
                                <a href="{{ route('data_base.index')}}" class="link-course">
                                    <div class="card card-block">
                                        <img class="track_img"
                                             src="https://img-a.udemycdn.com/course/240x135/1906852_93c6.jpg"
                                             alt="Photo of sunset">
                                        <h5 class="card-title  mt-3 mb-3">DataBase</h5>
                                        <p class="card-text">A database is an organized collection of data, generally
                                            stored and accessed electronically from a computer system. Where databases
                                            are more complex</p>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="col-lg-12">
                <section class="widget">
                    ...
                    <div class="widget-body">
                        <div class="row">
                            <div class="col-lg-10">
                                <p class="recomment_material">Some degree and certificate programs have courses you must
                                    take in order to become eligible for admission to the program. If you are an
                                    undergraduate independent student planning on eventually pursuing a degree or a
                                    certificate, you may wish to use your independent studies to complete courses that
                                    will help you fulfill the requirements of your intended future program</p>
                            </div>
                            <div class="col-lg-2">
